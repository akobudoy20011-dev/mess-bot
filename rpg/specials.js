 ...
 * - powerful mechanically unique abilities

 * - unlocked through affinity mastery, kingdoms, classes,

 *   bosses, quests, or story progression

 * - independent from normal spell weather/season penalties

 * - governed by their own cooldowns
 ...
 * Combat execution belongs to combat.js.
...
function getSpecialsByAffinity(
  ...
  return Object.values(
    ...
    special =>
      ...
      special.affinity === key

  );

}

function getSpecialsByCategory(
...
// PLAYER SPECIAL RECORDS

// ============================================================

function normalizePlayerSpecialRow(
...
async function getPlayerSpecials(
...
async function getPlayerSpecial(
...
async function checkSpecialRequirements(
  ...
  if (
    ...
    return {
      ...
      reason:
        ...
        `You have not unlocked the ` +

        `${special.affinity} affinity.`,
  ...
  if (
    ...
    return {
      ...
      reason:
        ...
        `Requires ${requiredMastery.toLocaleString()} ` +
   ...
   * Political kingdom requirement.

   *

   * IMPORTANT:

   * Kingdoms here are only:
  ...
  if (
    ...
    const requiredKingdom =
      ...
      String(
        ...
        special.requirements.kingdom

      );

    /*

     * A traitor cannot receive a

     * special belonging to the kingdom
    ...
    if (
      ...
      return {
        ...
        reason:
          ...
          "Your betrayal prevents you from " +

          "receiving this kingdom's special move.",
    ...
    if (
      ...
      return {
        ...
        reason:
          ...
          `Requires allegiance to ${requiredKingdom}.`,
...
async function unlockSpecial(
   ...
   * This keeps the module compatible with

   * different progression callers.
   ...
   * Quest/boss/story systems can explicitly

   * bypass normal acquisition requirements.

   *

   * This is important because a kingdom quest

   * may itself be the thing that grants the

   * special after its requirements have already
  ...
  if (
    ...
    const requirementCheck =
      ...
      await checkSpecialRequirements(
...
async function addSpecialMastery(
  ...
  if (
    ...
    throw new Error(
      ...
      "Special mastery must be greater than zero."
...
async function canUseSpecial(
  ...
  if (!owned) {
    ...
    return {
      ...
      reason:
        ...
        `You have not unlocked ${special.name}.`,
  ...
  if (
    ...
    return {
      ...
      reason:
        ...
        "This special can only be used in the morning.",
  ...
  if (
    ...
    return {
      ...
      reason:
        ...
        "This special can only be used during combat.",
   ...
   * Cooldown itself is deliberately NOT stored

   * here. combat.js owns active combat state and
   ...
   * against the combat round/timestamp.
...
function formatSpecial(
  ...
  if (
    ...
    requirements.affinityTier

  ) {

    lines.push(

      `Required Affinity: ${requirements.affinityTier}`
