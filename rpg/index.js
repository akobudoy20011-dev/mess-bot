...
/* =========================================================
   HELP — root-level category alias map

   Each category collapses to a single bare "!<alias>" on the
   root "!rpg help" menu instead of dumping every command.
   "!rpg help <category>" still shows the full command list
   for that category (unchanged below).

   NOTE: "kingdoms" here points at "!kingdom" (singular info +
   pledge), which is the entry point most people actually want
   from a help menu. The reputation/quest side ("!rpg kingdoms",
   plural) is still listed in the full kingdoms category page
   and is not lost — it's just not the one-line root alias.
========================================================= */
...
async function handleHelp(
  ...
  /*
   * Condensed root menu: one line per category — emoji, name,
   * and the single bare alias that jumps straight into it.
   * Full command lists still live behind "!rpg help <category>".
   */
  const lines =
    Object.entries(
      HELP_CATEGORIES
  ...
  lines.push(
    "",
    "Full command list: !rpg help <category>",
    "",
    "💡 Bare aliases work standalone — e.g. !kingdom, !army, !dungeon."
  );
