...
function helpText() {
  return [
    ...
    "GAME LOOP",
    "1. Start a mode.",
    "2. Inspect the evidence ECLIPSE lists.",
    "3. Compare clues and contradictions.",
    "4. Use !<mode> hint if you get stuck.",
    "5. Make the final call with the command shown.",
    "",
    "Every case has a 10-minute limit.",
    "You need evidence before a final conclusion.",
    "Hints help, but reduce the final reward.",
    "Recent scenarios are avoided so rounds feel less repetitive.",
    "",
